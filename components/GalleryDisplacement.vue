							...
							<div class="c-3d-image-wrapper">
								<div class="c-3d-image-container js-3d-image-container">
									...
									<div
										...
										data-depth-map="/assets/images/displacement/map-01.jpg"
...
export default {
	...
	methods: {
		...
		initThreeDEvents(
			...
			function animate() {
				i++;
				container.style.opacity = 1 - i / 1000;
				displacementFilter.scale.x = 1 + i / 1000 * horizontalThreshold;
				displacementFilter.scale.y = 1 + i / 1000 * verticalThreshold;
			...
			// });
			// displacementFilter.animate({
			// 	scale: [1, 2],
			// }, {
			// 	duration: 2000,
			// });
			// this.$anime({
			// 	targets: displacementFilter,
			// 	scale: [1, 1.1],
			// 	duration: 2000,
			// });
		},
